...
import com.modelfabric.client.sparql.spray.client.{SparqlHttpSprayClient, QuerySolution, MessageSparqlClientQueryEnd}
...
import com.modelfabric.client.sparql.spray.client._
